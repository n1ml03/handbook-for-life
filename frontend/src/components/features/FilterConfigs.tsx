...
export const createAccessoryFilterConfig = (
  rarities: string[],
  types: string[],
  versions: string[] = [],
): FilterField[] => [
...
export const createSwimsuitFilterConfig = (
  rarities: string[],
  characters: string[],
  releaseYears: string[],
  versions: string[] = [],
...
export const createShopFilterConfig = (
  types: string[],
  rarities: string[],
  currencies: string[],
): FilterField[] => [
...
export const createEventFilterConfig = (
  eventTypes: string[],
): FilterField[] => [
  {
    key: "search",
...
export const createGachaFilterConfig = (
  types: string[],
  statuses: string[],
  versions: string[] = [],
): FilterField[] => [
...
export const createSkillFilterConfig = (
  skillTypes: string[],
  targets: string[],
): FilterField[] => [
  {
...
export const createDecorBromideFilterConfig = (
  types: string[],
  rarities: string[],
  characters: string[],
  sources: string[],
...
export const createMemoriesFilterConfig = (
  types: string[],
  characters: string[],
  versions: string[] = [],
): FilterField[] => [
...
export const createFestivalFilterConfig = (
  types: string[],
  statuses: string[],
  versions: string[] = [],
): FilterField[] => [
