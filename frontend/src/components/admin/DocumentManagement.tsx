...
import { Trash2, Plus, BookOpen, CheckCircle2, FileText } from 'lucide-react';
...
export interface DocumentManagementProps {
  ...
  activeDocumentSection: 'checklist' | 'guide' | 'all';
