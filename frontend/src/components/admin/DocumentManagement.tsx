...
import { OptimizedCardGrid } from "@/components/ui/OptimizedCardGrid";
import {
...
export interface DocumentManagementProps {
  ...
  onSectionChange: (
    section: "checklist" | "guide" | "tutorial" | "all",
  ) => void;
...
export const DocumentManagement: React.FC<DocumentManagementProps> = ({
  ...
  const renderDocumentCard = useMemo(
        ...
        <div className="flex justify-between items-start">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-muted-foreground mb-2 line-clamp-2 text-sm">
              {document.summary_en ||
                extractContentText(document.content_json_en).slice(0, 150)}
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          {activeDocumentSection === "all" ? "total" : activeDocumentSection}{" "}
          document{sectionDocuments.length !== 1 ? "s" : ""}
        </div>
      </div>
