...
export const TestingToolsManagement: React.FC<
  TestingToolsManagementProps
> = () => {
  ...
  const renderTestingToolCard = useMemo(
    () => (tool: TestingTool, index: number) => (
      <motion.div
      ...
      {testingTools.length === 0 && (
        <div className="doax-card p-8 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Testing tools will appear here when configured
          </p>
        </div>
      )}
    </div>
