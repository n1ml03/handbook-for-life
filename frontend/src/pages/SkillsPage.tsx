...
import { type Skill, type SortDirection, type SkillCategory } from "@/types";
  ...
  const header = (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div
            className={`inline-flex items-center space-x-1 px-3 py-1 rounded-full text-xs font-bold text-white shadow-lg ${getCategoryColor(skill.skill_category)} mb-1`}
          >
            {getCategoryIcon(skill.skill_category)}
    ...
    >
      <div className="modern-page">
        <div className="modern-container-lg">
          ...
          >
            <h1 className="modern-page-title">Skills Collection</h1>
          </motion.div>
