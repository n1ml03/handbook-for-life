...
export default function CharacterDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "skills" | "swimsuits" | "details"
  >("overview");
  ...
  const getSkillCategoryIcon = (category: string) => {
    ...
    if (categoryLower.includes("passive"))
      return <Shield className="w-4 h-4" />;
    if (categoryLower.includes("potential"))
          ...
          <div className="relative z-10">
            <div className="flex flex-col sm:flex-row lg:flex-row items-center sm:items-start gap-4 sm:gap-6 lg:gap-8">
              ...
              <div className="flex-1 min-w-0 text-center sm:text-left">
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-3 sm:mb-4">
                  ...
                  {character.game_version && (
                    <Badge className="bg-gradient-to-r from-indigo-400 to-blue-500 text-white font-semibold text-xs sm:text-sm">
                      <GitBranch className="w-3 h-3 mr-1" />v
                      {character.game_version}
                    </Badge>
                  )}
                </div>
                ...
                {character.name_jp &&
                  character.name_en &&
                  character.name_jp !== character.name_en && (
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
                  <div className="text-center p-2 sm:p-3 bg-dark-primary/30 rounded-lg sm:rounded-xl border border-dark-border/30">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-accent-cyan">
                      {characterStats?.totalSkills || 0}
                    </div>
                  ...
                  <div className="text-center p-2 sm:p-3 bg-dark-primary/30 rounded-lg sm:rounded-xl border border-dark-border/30">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-accent-pink">
                      {characterStats?.totalSwimsuits || 0}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-400">
                      Swimsuits
                    </div>
                  ...
                  <div className="text-center p-2 sm:p-3 bg-dark-primary/30 rounded-lg sm:rounded-xl border border-dark-border/30">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-accent-purple">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>
                  ...
                  {activeTab === "skills" &&
                    `Skills (${characterStats?.totalSkills || 0})`}
                  {activeTab === "swimsuits" &&
                    `Swimsuits (${characterStats?.totalSwimsuits || 0})`}
            ...
            {isTabDropdownOpen && (
              <div className="absolute top-full left-0 right-0 mt-1 bg-card border border-border rounded-lg shadow-lg z-10">
                {[
                  ...
                  {
                    id: "skills",
                    label: `Skills (${characterStats?.totalSkills || 0})`,
                    icon: <Zap className="w-4 h-4" />,
                  },
                  {
                    id: "swimsuits",
                    label: `Swimsuits (${characterStats?.totalSwimsuits || 0})`,
                  ...
                  <div className="modern-card p-4 sm:p-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-lg sm:text-xl lg:text-2xl font-bold text-accent-pink">
                  ...
                  <div className="modern-card p-4 sm:p-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-lg sm:text-xl lg:text-2xl font-bold text-accent-cyan">
                          {character.height} cm
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="modern-card p-4 sm:p-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base lg:text-lg font-bold text-accent-purple break-words">
                          {character.voice_actor_jp}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="modern-card p-4 sm:p-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base lg:text-lg font-bold text-accent-gold">
                          {character.measurements}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="modern-card p-4 sm:p-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base lg:text-lg font-bold text-indigo-400">
              ...
              <div className="modern-card p-4 sm:p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  {[
                    ...
                    {
                      label: "Chinese",
                      value: character.name_cn,
                      flag: "🇨🇳",
                      color: "from-red-500 to-yellow-500",
                    },
                    {
                      label: "Traditional Chinese",
                      value: character.name_tw,
                      flag: "🇹🇼",
                    ...
                    ({ label, value, flag, color }) =>
                      value && (
                        <div
                          key={label}
                          className="modern-card p-3 sm:p-4 bg-dark-primary/30"
                        >
                          ...
                          <div
                            className={`h-1 bg-gradient-to-r ${color} rounded-full mt-2`}
                          ></div>
                        </div>
                      ),
                  )}
              ...
              {(characterStats?.totalSkills || 0) === 0 ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  {skills.map((skill) => (
                    <div
                      key={skill.id}
                      className="modern-card p-4 sm:p-6 bg-dark-primary/30"
                    >
            ...
            <div className="modern-card p-4 sm:p-6 lg:p-8">
              ...
              {(characterStats?.totalSwimsuits || 0) === 0 ? (
                <div className="text-center py-8 sm:py-12">
                  ...
                  <p className="text-gray-400 text-base sm:text-lg">
                    No swimsuits available for this character
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    >
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 sm:mb-4 gap-2">
                        <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
                          <Badge
                            className={`text-xs sm:text-sm font-bold bg-gradient-to-r ${getRarityColor(swimsuit.rarity)} text-white px-2 sm:px-3 py-1`}
                          >
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs sm:text-sm text-accent-cyan font-bold">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            className={`text-xs ${swimsuit.has_malfunction ? "bg-orange-500" : "bg-gray-500"}`}
                          >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            className={`text-xs ${swimsuit.is_limited ? "bg-purple-500" : "bg-gray-500"}`}
                          >
                        ...
                        {swimsuit.name_jp &&
                          swimsuit.name_jp !== swimsuit.name_en && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30 gap-1 sm:gap-0">
                      ...
                      <span className="text-white font-mono font-bold text-sm sm:text-base break-all">
                        {character.id}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30 gap-1 sm:gap-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30 gap-1 sm:gap-0">
                      ...
                      <Badge
                        className={`text-xs sm:text-sm ${character.is_active ? "bg-green-500" : "bg-gray-500"}`}
                      >
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30 gap-1 sm:gap-0">
                      ...
                      <span className="text-accent-cyan font-bold text-lg sm:text-xl">
                        {characterStats?.totalSkills || 0}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30 gap-1 sm:gap-0">
                      ...
                      <span className="text-accent-pink font-bold text-lg sm:text-xl">
                        {characterStats?.totalSwimsuits || 0}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30 gap-1 sm:gap-0">
                ...
                <div className="modern-card p-4 sm:p-6 lg:p-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
                    {["SSR+", "SSR", "SR", "R", "N"].map((rarity) => {
                      ...
                      const percentage =
                        swimsuits.length > 0
                          ? ((count / swimsuits.length) * 100).toFixed(1)
                          : "0";
                      return (
                        <div
                          key={rarity}
                          className="text-center p-3 sm:p-4 lg:p-6 bg-dark-primary/30 rounded-lg sm:rounded-xl border border-dark-border/30"
                        >
                          <div
                            className={`text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r ${getRarityColor(rarity)} bg-clip-text text-transparent mb-1 sm:mb-2`}
                          >
                            {count}
                          </div>
                          ...
                          <div
                            className={`h-1 sm:h-2 bg-gradient-to-r ${getRarityColor(rarity)} rounded-full mt-2 sm:mt-3 opacity-60`}
                          ></div>
                        </div>
                      );
                    })}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                    {characterStats?.skillCategories?.map((category) => {
                      ...
                      return (
                        <div
                          key={category}
                          className="flex items-center gap-3 p-3 sm:p-4 bg-dark-primary/30 rounded-lg border border-dark-border/30"
                        >
                          <div className="flex-shrink-0">
                          ...
                          <div className="text-base sm:text-lg font-bold text-accent-cyan">
                            {count}
                          </div>
                        </div>
                      );
